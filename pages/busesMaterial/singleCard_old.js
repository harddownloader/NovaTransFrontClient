...
class SingleCard extends Component {
  ...
  showDetailModal = (e) => {
    ...
    this.setState({
      ...
      'showDetailModal visibleDetailsModal',
      this.state.visibleDetailsModal
    ))
  }
  ...
  handleDetailModalCancel = (e) => {
    ...
    this.setState({
      ...
      'handleDetailModalCancel visibleDetailsModal',
      this.state.visibleDetailsModal
    ))
  }
  ...
  getTripContent = (ticketDescription, bus, stCollapse, isTimeInTripVisible) => {
    return (
      <div
  ...
  render() {
    ...
    return (
      <div className={styles.ticket} onClick={(e) => this.showDetailModal(e)}>
        <div className={styles.root}>
          ...
          <div type="only" className={styles.preview}>
            ...
            <Collapse in={this.state.expanded} timeout="auto" unmountOnExit>
              {this.getTripContent(ticketDescription, bus, stCollapse)}
            </Collapse>
          </div>
        </div>
        ...
        />}
        {visibleDetailsModal && <TripDetails
          handleCancel={this.handleDetailModalCancel}
          visible={visibleDetailsModal}
          tripDetails={this.getTripContent.bind(this, ticketDescription, bus)}
          fare={this.state?.bus?.fare}
          showSeatModal={this.showSeatModal}
        />}
      </div>
    );
  }
